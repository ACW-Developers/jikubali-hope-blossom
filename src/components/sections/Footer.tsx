...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    about: [
      { label: "Home", href: "/", icon: Users2 },
      { label: "About", href: "/about", icon: Users },
      { label: "Program", href: "/programs", icon: Briefcase },
  ...
  const socialLinks = [
    ...
    { icon: TikTokIcon, href: "https://www.tiktok.com/@jikubali.africa", label: "TikTok", color: "hover:text-pink-300" },
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl" style={{ backgroundColor: colorPalette.lighter }}>
                  ...
                  <span className="text-sm">+254 742 749 461</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl" style={{ backgroundColor: colorPalette.lighter }}>
